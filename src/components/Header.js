...
const Header = ({ isMenuOpen, toggleMenu, activeMegaMenu, toggleMegaMenu, serviceMenuItems, industries }) => {
  return (
    <header className="bg-white bg-opacity-90 backdrop-blur-md shadow-lg sticky top-0 z-50 border-b border-white border-opacity-20">
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between py-5">
          {/* Logo */}
          <a href="/" className="transition-transform hover:scale-105">
            <img src="/assets/logo/switch_Pro_logo.png" alt="Switch Waste Solutions Logo" className="h-14 w-auto" />
          </a>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t">
            <div className="space-y-4">
              ...
              <Link to="/clients" className="block text-gray-700 hover:text-blue-600 py-2">Clients</Link>
