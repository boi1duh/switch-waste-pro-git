...
const Services = () => {
  return (
    <>
      <SEO
        title="Our Waste Management Services | Switch Waste"
        description="Comprehensive waste management solutions for healthcare risk waste, pharmaceutical waste, hazardous materials, and general recycling. SANS compliant and environmentally responsible."
        keywords="waste management services, healthcare waste, pharmaceutical disposal, hazardous waste, recycling solutions, Johannesburg"
        canonical="/services"
      />
      <Hero
        title="Our Waste Management Services"
        subtitle="Comprehensive solutions for healthcare and general waste with complete regulatory compliance."
