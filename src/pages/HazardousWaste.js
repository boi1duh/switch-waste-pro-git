  ...
  return (
    <>
      <Hero
        ...
        title="Specialized Hazardous Solutions"
        ...
        backgroundImage={`${process.env.PUBLIC_URL}/assets/services/hazardous-waste.jpg`}
      ...
      >
        <div className="bg-white bg-opacity-10 backdrop-blur-md p-8 rounded-2xl shadow-2xl max-w-lg border border-white border-opacity-20">
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="flex items-center gap-4 bg-white bg-opacity-10 rounded-lg p-4 backdrop-blur-sm text-red-300">
      ...
      <Carousel slides={hazardousSlides} />

      <ContentSection title="South African Hazardous Waste Regulations" hasOverlay>
      ...
      <ContentSection
        title="Our Hazardous Waste Services"
        subtitle="Specialized handling of hazardous materials with full regulatory compliance and environmental protection"
        bgColor="bg-gray-50"
        hasOverlay
      >
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4 text-center text-blue-600">
              <FaFileSignature className="inline-block" />
            </div>
      ...
      <ContentSection
        ...
        subtitle="Our hazardous waste management prioritizes safety, environmental protection, and regulatory compliance"
        bgColor="bg-red-600"
        titleColor="text-white"
      >
        <div className="grid md:grid-cols-3 gap-8 text-white">
          <div className="text-center">
            <div className="text-4xl mb-4 text-red-300">
