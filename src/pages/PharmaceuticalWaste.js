...
const PharmaceuticalWaste = () => {
  ...
  // Initialize carousel
  const { currentSlide, goToSlide, nextSlide, prevSlide, isPaused } = useCarousel(pharmaSlides);
          ...
          <div className="relative">
            ...
            <div className="text-center text-white max-w-4xl mx-auto">
              ...
              <div className="flex justify-center gap-6">
                ...
                >
                  {pharmaSlides[currentSlide]?.ctaText}
                </Link>
              </div>
            </div>
