...
const About: React.FC<ServicesProps> = ({ services, industries }) => {
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Partner with Switch Waste Solutions</h2>
